...
<!-- 자동 슬라이드-->
<!-- 가운데 정렬 해야합니다.-->
<section class="px-5 py-5" id="features" style="background-color: aliceblue; text-align: center;">

	<div class="container px-5 my-5 border-3 ">
		<div class="row gx-5 sh">
			<h1 style="text-align: center;">금일의 갑론을박 주제</h1>
		</div>
			...
			<div class="slide slide_wrap ">
				...
				<div class="slide_item item2">
					<div class="overflow-hidden">
						<p>
						<h2 style="text-align: center;">
						<a href="board/list">주제 넣어주세요</a></h2>
						</p>
						<img src="" alt="">
					</div>
				</div>
					...
					<h2 style="text-align: center;">
						...
						<div
							...
							<div class="col p-1 d-flex flex-column position-static ">
								...
								<p class="card-text mb-auto"
									style="float: none; margin: 0 auto;"></p>
								<a href="이슈 명예 전당 페이지"
		...
		<div class="row gx-5 justify-content-center">
			<div class="col-lg-10 col-xl-7">
				<div class="text-center">
					<div class="fs-4 mb-4 fst-italic">광고나 글귀나 아니면 api 같은거 넣어도 되는
						섹션..</div>
					<div class="d-flex align-items-center justify-content-center">
						<img class="rounded-circle me-3"
							src="https://dummyimage.com/40x40/ced4da/6c757d" alt="..." />
						<div class="fw-bold">
							상윤 <span class="fw-bold text-primary mx-1">/</span> t1f4
						</div>
					</div>
				</div>
			</div>
