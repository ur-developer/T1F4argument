...
public class NoticeController {
		...
		public void listNotice(@ModelAttribute("cri") Criteria cri, Principal principal, Model model) {
			...
			model.addAttribute("list", service.getNoticeList(cri, principal));
		...
		public String getNotice(
	     ...
	     // 이미 방문한 경우 처리
	        if (hasVisited) {
	            // 이미 방문한 사용자에게 처리할 내용
	            model.addAttribute("board", service.getNotice(bno, principal));
	            return "notice/get";
	        }
		...
		public String removeNotice(
			...
			return "redirect:/notice/list" + cri.getLink();
		}
