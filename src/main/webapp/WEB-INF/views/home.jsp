...
<section class="py-5"
	...
	<p>
		<i>「명사」 여러 사람이 서로 자신의 주장을 내세우며 상대편의 주장을 반박함.</i>
	</p>
</section>
...
<section class="py-5 bg-light">
	...
	<div class="container px-5" style="width: 800px;">
		...
		<h2 style="text-align: center;">오늘의 실시간 검색어는?</h2>
		<hr class="layouts">
...
<!-- Testimonial section-->
<section class="py-5"
	style="background-color: #edae49; text-align: center;">
	<h2 style="margin-bottom: 30px; color: white;"text-align:center;>명예의
		유저</h2>
				...
				<h2 style="text-align: center;">
					...
					<div
						...
						<div class="text-end mb-5 mb-xl-0">
							<a class="text-decoration-none" href="/notice/list"> 공지사항 보기
