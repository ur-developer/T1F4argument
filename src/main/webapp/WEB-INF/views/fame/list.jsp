		...
		<div
			...
			<div class="col p-1 d-flex flex-column position-static">
				...
				<c:forEach var="board" items="${getFirstFameList}">
					...
					<br>
					<br>
					<h3 class="card-text mb-auto" style="float: none; margin: 0 auto;">${board.content}</h3>
						...
						<c:forEach var="board" items="${getSecondFameList}">
							...
							<div class="mb-1 text-body-secondary"
								...
								<fmt:formatDate pattern="yyyy-MM-dd"
									value="${board.registerDate}" />
							</div>
							<br>
							<br>
							<p class="card-text mb-auto" style="float: none; margin: 0 auto;">${board.content}</p>
							<div class="likes-icon">
								<i class="fa-solid fa-thumbs-up"></i>
							</div>
							<div>
